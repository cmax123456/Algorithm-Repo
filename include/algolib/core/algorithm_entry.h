...
// zh: model-info view for scheduling/ops side. Contains resource_profile
// (params/flops/bandwidth/preferred_compute), invocation (no internal
// model_uri/endpoint leak) and deployment (from DeploymentSpec).
